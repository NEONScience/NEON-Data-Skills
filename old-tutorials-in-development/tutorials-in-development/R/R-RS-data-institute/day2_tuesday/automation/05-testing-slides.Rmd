...
short description that explains the nature of the test. Keep it short and
...
Tip: Spending a little bit of time thinking about the message helps refine the nature 
of the test and be more careful about what you test.
...
- `expect_warning()` and `expect_error()` are useful to make sure that your functions 
produce warnings
