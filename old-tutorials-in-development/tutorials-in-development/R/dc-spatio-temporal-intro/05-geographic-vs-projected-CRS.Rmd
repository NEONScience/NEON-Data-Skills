...
from the (0,0) point of zone 18. Notice that including the latitude band ("T") 
can be redundant because the northing coordinate supplies the information needed 
to define the point's latitude.
