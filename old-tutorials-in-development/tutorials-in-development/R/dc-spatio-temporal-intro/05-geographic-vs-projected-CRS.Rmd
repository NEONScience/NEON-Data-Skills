...
# read shapefile
worldBound <- readOGR(dsn="ne_110m_land",
                      layer="ne_110m_land")
...
# read grat shapefile
worldGrat30 <- readOGR(dsn="ne_110m_graticules_all",
...
#import box
wgs84Box <- readOGR(dsn="ne_110m_graticules_all",
...
The N denotes that this point is in the Northern, not Southern, hemisphere. Occassionally, 
you may see: 
...
### Challenge: Practice understanding UTM coordinates

The Penn State E-Education Institute has an interactive tool that you can use to explore UTM coordinate reference systems.

<a href="https://www.e-education.psu.edu/natureofgeoinfo/sites/www.e-education.psu.edu.natureofgeoinfo/files/flash/coord_practice_utm_v06.swf" target="_blank">Download the UTM interactive tool</a>. Note: You will need Adobe Flash Player to use this tool.
