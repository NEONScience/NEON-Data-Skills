...
The $summary table sums the number of records in the input dataframe and summarizes how many individual records, unique events (since a event that is longer than one month with have multiple records), and unique event types. 
...
``` {r fire-dates, summarizeSIM}
fireSummary <- neonSiteMgmtEventData::summarizeSIM(df= fires$sim_eventData)
...
For more information and examples how how the `createSIMPolygon` works please see the vignette associated with the package. 
