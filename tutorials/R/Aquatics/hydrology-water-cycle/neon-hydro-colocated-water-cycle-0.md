...
flag (SRF) date range, flag value, and justification applied to the data
included in this download. #NH comment: justification applied to the
data or the flag?</li>
...
<h3>R</h3>
<pre class="r"><code># Download stream morpholog data for the lifetime of a site
...
<h3>Python</h3>
<pre class="python"><code># Download stream morpholog data for the lifetime of a site
