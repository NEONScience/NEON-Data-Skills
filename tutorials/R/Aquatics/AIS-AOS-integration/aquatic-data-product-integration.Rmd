...
```{r sampler-habitat-type, results='asis'}
...
```{r inv-abundance-wrangle, echo=TRUE}
...
```{r inv-abundance-plot, echo=TRUE}
...
```{r inv-richness-wrangle, echo=TRUE}
...
```{r inv-richness-calculate, echo=TRUE}
# calculate richness
...
```{r plot-fDOM-waq, echo=TRUE, fig.height=4, fig.width=8}
...
```{r case-study-2-fiona, echo=TRUE}
...
```{r convert-numeric-geo, echo=TRUE}
...
```{r highlight-fiona-psd, echo=TRUE}
...
```{r case-study-3-wrangle, echo=TRUE}
