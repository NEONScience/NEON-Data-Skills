...
![ ]({{ site.baseurl }}/images/rfigs/R/dc-spatial-raster/03-Raster-Calculations-In-R/raster-math-1.png)
...
<a href="http://{{ site.baseurl }}/science-design/field-sites/san-joaquin-experimental-range" target="_blank" >NEON San Joaquin Experimental Range (SJER) field site </a> 
