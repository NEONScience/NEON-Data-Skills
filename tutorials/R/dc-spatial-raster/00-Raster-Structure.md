...
* <a href="http://neondataskills.org/raster-data-r
" target="_blank" >
...
<a href="http://{{ site.baseurl }}/science-design/collection-methods/airborne-remote-sensing" target="_blank"> 
...
the standard used by the <a href="http://{{ site.baseurl }}" target="_blank"> 
