...
contributors:	
estimatedTime:	
packagesLibraries: raster, rgdal, NEON, data
topics: raster, spatial-data-gis, NEON, data
languagesTool: R, NEON, data
dataProduct:
...
* <a href="{{ site.baseurl }}/raster-data-r" target="_blank"> NEON Data Skills tutorial: Raster Data in R - The Basics</a>
* <a href="{{ site.baseurl }}/image-raster-data-r" target="_blank"> NEON Data Skills tutorial: Image Raster Data in R - An Intro</a>
...
<figure>
    <a href="{{ site.baseurl }}/images/spatialData/NLCD06_conus_lg.gif ">
...
![ ]({{ site.baseurl }}/images/rfigs/R/dc-spatial-raster/00-Raster-Structure/view-raster-histogram-1.png)
...
<a href="{{ site.baseurl }}/dc-multiband-rasters-r" target="_blank"> *Work with Multi-band Rasters: Images in R*</a>.
