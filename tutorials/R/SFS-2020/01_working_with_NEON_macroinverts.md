...
![ ]({{ site.baseurl }}/images/rfigs/R/SFS-2020/01_working_with_NEON_macroinverts/long-data-1.png)
    ...
    ## 1 D02      POSE    2014 POSE.201… POSE.20140… riffle      Coleop…      516. 
    ## 2 D02      POSE    2014 POSE.201… POSE.20140… riffle      Epheme…     5172. 
    ## 3 D02      POSE    2014 POSE.201… POSE.20140… riffle      Odonata      129. 
    ## 4 D02      POSE    2014 POSE.201… POSE.20140… riffle      Plecop…     1290. 
    ## 5 D02      POSE    2014 POSE.201… POSE.20140… riffle      Tricho…     8839. 
    ## 6 D02      POSE    2014 POSE.201… POSE.20141… pool        Collem…       34.9
...
Let's compare the different orders q = 0, 1, and 2 measures of alpha diversity across the samples collected from ARIK, POSE, and MAYF.
    ...
    ##   <chr>  <list>                  <dbl>
    ## 1 POSE   <tibble [77 × 369]>      37.5
    ## 2 MAYF   <tibble [103 × 369]>     22.6
    ## 3 ARIK   <tibble [95 × 369]>      23.3
    ...
    ## 1 POSE          77     37.5    14.7     6.91    6.43      259     94.8
    ## 2 MAYF         103     22.6     9.77    9.53    6.56      215     64.2
    ## 3 ARIK          95     23.3     8.35    8.13    5.99      189     50.0
...
Finally, we will use Nonmetric Multidimensional Scaling (NMDS) to ordinate samples as shown below:
    ...
    ## Run 0 stress 0.2176421 
    ## Run 1 stress 0.2184172 
    ## Run 2 stress 0.2137704 
    ## ... New best solution
    ## ... Procrustes: rmse 0.02310481  max resid 0.1616692 
    ## Run 3 stress 0.2168338 
    ## Run 4 stress 0.2142435 
    ## ... Procrustes: rmse 0.01201177  max resid 0.125825 
    ## Run 5 stress 0.2226748 
    ## Run 6 stress 0.2242336 
    ## Run 7 stress 0.2386504 
    ## Run 8 stress 0.2429866 
    ## Run 9 stress 0.2137731 
    ## ... Procrustes: rmse 0.01181612  max resid 0.1267906 
    ## Run 10 stress 0.220975 
    ## Run 11 stress 0.2347412 
    ## Run 12 stress 0.2310256 
    ## Run 13 stress 0.213475 
    ## ... New best solution
    ## ... Procrustes: rmse 0.01923398  max resid 0.166482 
    ## Run 14 stress 0.2204814 
    ## Run 15 stress 0.2153352 
    ## Run 16 stress 0.2177829 
    ## Run 17 stress 0.2414236 
    ## Run 18 stress 0.2255211 
    ## Run 19 stress 0.216586 
    ## Run 20 stress 0.2323321 
...
![ ]({{ site.baseurl }}/images/rfigs/R/SFS-2020/01_working_with_NEON_macroinverts/NMDS-1.png)
    ...
    ## 1 ARIK.20160919.KICKNET.3 1.0252038 -0.073286288      D10   ARIK
    ## 2  POSE.20150721.SURBER.1 1.0175945 -1.104043919      D02   POSE
    ## 3 ARIK.20160919.KICKNET.4 1.0171954  0.386938648      D10   ARIK
    ## 4 ARIK.20160331.KICKNET.3 0.8628419  0.529679810      D10   ARIK
    ## 5    ARIK.20160919.CORE.3 0.8587757 -0.292247422      D10   ARIK
    ## 6 ARIK.20160919.KICKNET.1 0.7857015 -0.009820651      D10   ARIK
    ##    namedLocation         collectDate       eventID year habitatType
    ## 1 ARIK.AOS.reach 2016-09-19 22:06:00 ARIK.20160919 2016         run
    ## 2 POSE.AOS.reach 2015-07-21 14:43:00 POSE.20150721 2015      riffle
    ## 3 ARIK.AOS.reach 2016-09-19 22:06:00 ARIK.20160919 2016         run
    ## 4 ARIK.AOS.reach 2016-03-31 15:41:00 ARIK.20160331 2016         run
    ## 5 ARIK.AOS.reach 2016-09-19 22:06:00 ARIK.20160919 2016        pool
    ## 6 ARIK.AOS.reach 2016-09-19 22:06:00 ARIK.20160919 2016         run
    ##       samplerType benthicArea          inv_dens_unit
    ## 1 modifiedKicknet       0.250 count per square meter
    ...
    ##                   sampleID      NMDS1       NMDS2 domainID siteID
    ## 270   POSE.20141028.HESS.2 -0.8688367 -1.27896134      D02   POSE
    ## 271 POSE.20161031.SURBER.4 -0.9088648  0.04664401      D02   POSE
    ## 272   MAYF.20160321.SNAG.3 -0.9333496 -0.58870394      D08   MAYF
    ## 273   MAYF.20150324.SNAG.3 -1.1389248  0.08777595      D08   MAYF
    ## 274   MAYF.20180326.CORE.3 -1.1815116  0.02241812      D08   MAYF
    ## 275   MAYF.20141114.SNAG.2 -1.5088042 -0.87458312      D08   MAYF
    ##      namedLocation         collectDate       eventID year habitatType
    ## 270 POSE.AOS.reach 2014-10-28 15:20:00 POSE.20141028 2014        pool
    ## 271 POSE.AOS.reach 2016-10-31 14:01:00 POSE.20161031 2016      riffle
    ## 272 MAYF.AOS.reach 2016-03-21 16:09:00 MAYF.20160321 2016         run
    ## 273 MAYF.AOS.reach 2015-03-24 17:15:00 MAYF.20150324 2015         run
    ## 274 MAYF.AOS.reach 2018-03-26 14:50:00 MAYF.20180326 2018         run
    ## 275 MAYF.AOS.reach 2014-11-14 16:30:00 MAYF.20141114 2014      riffle
    ##     samplerType benthicArea          inv_dens_unit
    ## 270        hess       0.086 count per square meter
    ## 271      surber       0.093 count per square meter
    ## 272        snag       0.152 count per square meter
    ## 273        snag       0.076 count per square meter
    ## 274        core       0.006 count per square meter
    ## 275        snag       0.106 count per square meter
