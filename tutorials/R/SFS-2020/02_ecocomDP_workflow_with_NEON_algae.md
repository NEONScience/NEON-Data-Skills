...
In this first step, we show how to search the ecocomDP database for macroinvertibrate data including those from LTER and NEON sites (and others).
    ...
    ## Stacking took 0.786428 secs
    ## All unzipped monthly data folders have been removed.

    ## Joining, by = "sampleID"

    ## Warning in if (detected != expected) {: the condition has length > 1 and
...
Now that we have downloaded the data, let's take a look at tht `ecocomDP` data object structure:
    ...
    ## 1 9e013f88-8463-4be2-8475-da816cdfa8f6 POSE.20140722.SURBER.1       <NA>
    ## 2 4ab7e7a9-bc7e-451f-9eec-0d25924a4dfd POSE.20140722.SURBER.1       <NA>
    ## 3 9e958d7e-79d1-45fd-bafd-586964d4d26e POSE.20140722.SURBER.1       <NA>
    ## 4 c4deafd4-ed61-4a15-9c06-29a27338d5e9 POSE.20140722.SURBER.1       <NA>
    ## 5 a08ab6fd-10e3-4f5f-8bac-b6eb35d21c15 POSE.20140722.SURBER.1       <NA>
    ## 6 130571ba-09fe-4b89-a752-361a710265cb POSE.20140722.SURBER.1       <NA>
    ##      location_id observation_datetime taxon_id variable_name     value
    ## 1 POSE.AOS.reach  2014-07-22 13:10:00   STEFEM       density  258.0645
    ## 2 POSE.AOS.reach  2014-07-22 13:10:00    BAESP       density  129.0323
    ## 3 POSE.AOS.reach  2014-07-22 13:10:00   PERSP1       density  129.0323
    ## 4 POSE.AOS.reach  2014-07-22 13:10:00   CHESP5       density 2075.2688
    ## 5 POSE.AOS.reach  2014-07-22 13:10:00   CHESP5       density  258.0645
    ## 6 POSE.AOS.reach  2014-07-22 13:10:00   LEUSP8       density  258.0645
    ##                     unit
...
Let's download the data for the NEON "Periphyton, seston, and phytoplankton collection" from "ARIK" and view its structure:
    ...
    ## 1 DP1.20166.001.20200624145341 ARIK.AOS.reach  2014-07-15 18:00:00
    ## 2 DP1.20166.001.20200624145341 ARIK.AOS.reach  2014-07-15 18:00:00
    ## 3 DP1.20166.001.20200624145341 ARIK.AOS.reach  2014-07-15 18:00:00
    ## 4 DP1.20166.001.20200624145341 ARIK.AOS.reach  2014-07-15 18:00:00
    ## 5 DP1.20166.001.20200624145341 ARIK.AOS.reach  2014-07-15 18:00:00
    ## 6 DP1.20166.001.20200624145341 ARIK.AOS.reach  2014-07-15 18:00:00
