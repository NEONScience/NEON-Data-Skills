...
#install.packages("rgeos")  # working with spatial data
install.packages("broom")  # tidy up data
install.packages("ggplot2")  # plotting
#install.packages("ggthemes")  # applying consistent themes to plots
install.packages("maptools")  # working with spatial data & ggplot
...
# color is determined by the order that the unique values show up. check
...
```{r load}
pos <- read.delim("NEON_par/NEON.D05.TREE.DP1.00024.001.2018-07.basic.20190314T150344Z/NEON.D05.TREE.DP1.00024.001.sensor_positions.20190314T150344Z.csv", sep=",", header=T)
...
In the The HOR and VER indices in the sensor positions file correspond to the 
