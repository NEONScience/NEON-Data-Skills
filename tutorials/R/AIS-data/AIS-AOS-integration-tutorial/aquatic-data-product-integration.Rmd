...
pebbleCount_plot <- geo_pebbleCount_freqCumm%>%
...
AOS_AIS_plot_CUPE_Fiona_psd <- AOS_AIS_plot_CUPE_Fiona%>%
  layout(images=list(
...
AOS_AIS_plot_CUPE_Fiona_psd

# re-generate the GUIL plot with particle size distribution subplots added
AOS_AIS_plot_GUIL_Fiona_psd <- AOS_AIS_plot_GUIL_Fiona%>%
  layout(images=list(
...
# create plot
DOC_continuous_plot <- plotly::plot_ly(data=fDOM_DOC_join)%>%
