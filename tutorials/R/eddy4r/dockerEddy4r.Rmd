...
* Docker Desktop for Windows - Type `ipconfig` into cmd.exe window. The output will include the DockerNAT IPv4 address that docker uses to communicate to the internet, which in most cases will be **10.0.75.1**. 
