...
```{r run-zipsByProduct_hidden, eval=TRUE, echo=FALSE, results="hide", message=FALSE, warning=FALSE}
...
```{r zips-to-stack, eval=TRUE, message=FALSE, warning=FALSE}
...
```{r aop-tile_hidden, eval=TRUE, echo=FALSE, results="hide"}
...
```{r read-par_hidden, eval=TRUE, echo=FALSE, results="hide"}
...
```{r read-par-var_hidden, eval=TRUE, echo=FALSE, results='hide'}
...
```{r read-vst_hidden, echo=FALSE, results='hide'}
...
```{r read-vst-var_hidden, eval=TRUE, echo=F, results='hide'}
...
```{r stems, echo=FALSE, results='hide', message=FALSE, warning=FALSE}
