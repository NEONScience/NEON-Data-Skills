...
```{r run-zipsByProduct, results="hide", message=FALSE, warning=FALSE}
...
```{r zips-to-stack, results="hide", message=FALSE, warning=FALSE}
...
```{r read-vst, , results="hide", message=FALSE, warning=FALSE}
