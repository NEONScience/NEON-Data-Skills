...
section of the tutorial, but we'll be using the downloaded Photosynthetically 
Active Radiation (PAR; DP1.00024.001) data downloaded for Wind River Experimental
Forest (WREF) and Abby For optimal results, download three 
