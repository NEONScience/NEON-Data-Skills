...
```{r hist-data, fig.cap=c("Histogram of reflectance values for band 9. Reflectance values are on the x-axis, and the frequency is on the y-axis.","Histogram of reflectance values between 0 and 5000 for band 9. Reflectance values are on the x-axis, and the frequency is on the y-axis.","Histogram of reflectance values between 5000 and 15000 for band 9. Reflectance values are on the x-axis, and the frequency is on the y-axis.")}
...
```{r set-values-NA, fig.cap="Plot of reflectance values for band 9 data with values equal to -9999 set to NA."}
...
```{r plot-log, fig.cap="Plot of log transformed reflectance values for the previous b9 image." }
...
<figure class="half">
    ...
    alt="RGB image of the SJER field site.">
    </a>
    ...
    alt="Plot of log transformed reflectance values for the b9 image previously plotted.">
    </a>
...
```{r transpose-data, fig.cap="Plot showing the transposed image of the log transformed reflectance values of b9."}
...
```{r  plot-colors-raster, fig.cap="Plot of the properly oriented raster image of B9 with custom colors."}
