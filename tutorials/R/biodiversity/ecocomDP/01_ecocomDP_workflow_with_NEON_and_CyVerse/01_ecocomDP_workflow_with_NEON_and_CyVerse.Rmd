...
```{r stacked-data-map, message=FALSE, warning=FALSE, fig.cap="Map of NEON and NTL LTER macroinvertebrate datasets"}
# plot on a US Map
stacked_inv %>% 
  plot_sites()
```
...
```{r stacked-abundances, message=FALSE, warning=FALSE, fig.cap="Abundances observed in NEON and NTL LTER macroinvertebrate datasets"}
