...
```{r plot targets, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: Beetle targets data at OSBS"}
targets %>% 
...
```{r plot null forecast, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: NULL forecasts of ground beetle abundance at OSBS"}
...
```{r plot clim data, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: modeled meteorology data at OSBS"}
...
```{r plot tslm modeled vs observed, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: TSLM predictions of beetle abundances at OSBS compared against observed data"}
# visualize model fit
...
Visualize the forecast.
```{r plot tslm forecast, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: TSLM forecast of beelte abundance at OSBS"}
# visualize the forecast
fc_best_lm %>% 
  autoplot(targets_train) +
  facet_grid(.model ~ .) + 
...
```{r plot tslm submission, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: TSLM forecast submission file for OSBS, parameter indicates emsemble member"}
...
```{r plot forecasts to raw target data, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: Compare Forecasts to Raw Data. Ensemble forecasts are the lines and the black circles are the direct observations."}
...
```{r plot forecast scores, fig.height = 6, fig.width = 12, fig.align = "center", fig.cap="Figure: Forecast scores (CRPS) for models predicting beetle abundance at the OSBS NEON site during the 2022 field season"}
