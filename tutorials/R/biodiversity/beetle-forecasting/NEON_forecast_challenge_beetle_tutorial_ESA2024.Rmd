...
```{r visualize forecasts to raw target data}
...
```{r plot forecast scores, fig.height = 4, fig.width = 8, fig.align = "center", fig.cap="Figure: Forecast scores (CRPS) for models predicting beetle abundance at the OSBS NEON site during the 2022 field season"}
all_mod_scores %>%
