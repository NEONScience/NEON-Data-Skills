...
<figure>
    ...
    <img src="https://raw.githubusercontent.com/NEONScience/NEON-Data-Skills/dev-aten/graphics/dc-spatial-vector/USMapDifferentProjections_MCorey_Opennews-org.jpg" alt="Examples of how different projections will alter the shape of a map in different ways.">
    </a>
...
```{r find-coordinates, fig.cap="Continental U.S. state boundaries."}
...
```{r check-out-coordinates, fig.cap="Continental U.S. state boundaries with the U.S. boundary emphasized with a thicker border."}
# Read the .csv file
...
```{r explore-units, fig.cap="Fisher Tower location represented by a point."}
...
``` {r layer-point-on-states, fig.cap="Continental U.S. state boundaries with the U.S. boundary emphasized with a thicker border; note that the Fisher Tower point is not currently visible."}
...
```{r plot-again, fig.cap="Continental U.S. state boundaries with the U.S. country border emphasized with a thicker border and with the Fisher Tower represented as a point." }
...
```{r challenge-code-MASS-Map,  include=TRUE, results="hide", echo=FALSE, warning=FALSE, fig.cap="A close-up view of the northeastern U.S. with the Fisher Tower location as a point symbol."}
