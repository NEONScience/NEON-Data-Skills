...
```{r elevation-map, fig.cap="Continuous elevation map of NEON's site Harvard Forest"}
...
```{r classified-elevation-map, fig.cap="Classified elevation map of NEON's site Harvard Forest"}
...
```{r view-raster-histogram, fig.cap="Histogram showing the distribution of digital surface model values that has a default maximum pixels value of 100,000"}
...
``` {r view-raster-histogram2, fig.cap="Histogram showing the distribution of digital surface model values with all pixel values included"}
