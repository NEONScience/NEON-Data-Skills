...
An overview of setting the working directory in R can be found <a href="https://www.neonscience.org/set-working-directory-r" target="_blank">here</a>.
...
```{r define-lidar-paths, results="hide" }
...
``` {r spatial-distribution-dsm-diff}
...
``` {r spatial-distribution-dtm-diff}
