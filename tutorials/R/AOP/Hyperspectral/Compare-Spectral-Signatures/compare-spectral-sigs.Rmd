...
Now, we will read in the RGB image that we created in the earlier tutorial <a href="https://www.neonscience.org/resources/learning-hub/tutorials/introduction-hyperspectral-remote-sensing-data-r#toggle-8" target="_blank">Creating a Raster Stack from Hyperspectral Imagery in HDF5 Format in R</a> and plot the raster. 
...
rgbStack <- rast(paste0(data_dir,"NEON_D17_SJER_DP3_257000_4112000_reflectance_2021_RGB.tif"))
