...
```{r no-data-values, fig.cap= "Histogram of discharge value. X-axis represents discharge values and the Y-axis shows the frequency." }
...
```{r plot-flood-data, fig.cap= "Stream Discharge for Boulder Creek. X-axis represents the Date and the Y-axis shows the discharge in cubic feet per second." }
...
```{r define-time-subset, fig.cap= "Stream discharge for Boulder Creek for the time period between August 15th and October 15th of 2013. X-axis represents the date and the Y-axis shows the discharge in cubic feet per second."  }
...
```{r plotly-discharge-data, fig.cap="Stream discharge for Boulder Creek for the time period between August 15th and October 15th of 2013. X-axis represents the date and the Y-axis shows the discharge in cubic feet per second.", eval=FALSE, comment=NA}
...
``` {r view-plotly, eval=F, comment=NA}
