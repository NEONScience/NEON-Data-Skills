...
packagesLibraries: rhdf5, ggplot2, dplyr, scales
topics: HDF5, data-management, time-series
languagesTool: R
dataProduct:
...
<a href="https://www.hdfgroup.org/downloads/hdfview/" target="_blank">HDFView</a> 
...
<figure>
    ...
    <img src="https://raw.githubusercontent.com/NEONScience/NEON-Data-Skills/dev-aten/graphics/NEON-general/NEONtower.png" alt="A NEON tower illustration with booms that house sensors"></a>
    <figcaption>A NEON tower contains booms, or arms, that house sensors at varying 
    heights along the tower.</figcaption>
</figure>


```{r readPlotData, fig.cap="Line graph of oscillating average temperature"}
...
```{r plot-temp-data, fig.cap="Line graph of oscillating average temperature with dates labeled on the x axis"}
...
<figure>
    ...
    <img src="https://raw.githubusercontent.com/NEONScience/NEON-Data-Skills/dev-aten/graphics/NEON-general/heating-curve_LNewman.jpg" alt="Graph of Earth's outgoing longwave radiation showing a minimum temperature in the morning and a maximum temperature in the late afternoon"></a>
    <figcaption>In many parts of the world, we'd expect the maximum temperature
    to occur during late afternoon. Source: <a href="https://www.gccaz.edu/directory/lynn-newman" target="_blank"> Lynn Newman </a></figcaption>
</figure>
...
```{r fix-time-zone, fig.cap="Line graph of average temperature lowest in the morning and highest in the afternoon"}
...
<a href="https://cran.rstudio.com/web/packages/dplyr/vignettes/dplyr.html" target="_blank">
...
Modify the loop above so that it adds the site name and the data type (1 minute) 
as columns in our data frame.
...
```{r plotBoomData, fig.cap="Line graph of average temperature with different colors for each boom's data"}
...
```{r compareGroupData, fig.cap="Average temperatures for the warmer Florida site and cooler Colorado site plotted on the same line graph"}
