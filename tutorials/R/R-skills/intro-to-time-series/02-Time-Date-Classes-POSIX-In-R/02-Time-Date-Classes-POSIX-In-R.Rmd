...
#Allows knitting with errors in code
```
...
#Download the data from the following URL -- https://harvardforest.fas.harvard.edu/data/p00/hf001/hf001-10-15min-m.csv
work.dir <- "~/Documents/"
```
...
harMet_15Min <- read.csv(
  file=paste0(work.dir,"hf001-10-15min-m.csv"),
