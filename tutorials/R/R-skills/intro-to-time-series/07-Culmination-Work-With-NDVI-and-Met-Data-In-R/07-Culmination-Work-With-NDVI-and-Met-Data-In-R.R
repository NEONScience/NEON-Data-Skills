...
## ----plot-NDVI, fig.cap="A scatterplot showing the relationship between date and mean NDVI value at Harvard Forest during the year 2011."----
# plot NDVI by date
...
## ----plot-same-xaxis, fig.cap="Two scatterplots combined in a single image.  Above: a scatterplot showing the relationship between date and daily photosynthetically active radiation at Harvard Forest during 2011.  Below: A scatterplot showing the relationship between date and daily NDVI at Harvard Forest during 2011. Notice x-axis scales are now concordant between top and bottom panels."----
# plot PAR
