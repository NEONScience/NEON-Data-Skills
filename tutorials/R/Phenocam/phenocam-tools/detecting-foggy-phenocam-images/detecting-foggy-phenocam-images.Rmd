...
Let's explain and extact the three elements, one at a time.
...
Consider the histogram in relation to the RGB image. Why are we getting so many image pixels up in the high range of the brightness? Where does this correlate to on the RGB image?
...
Consider the RGB image and the histogram. What aspects of the image may be contributing to the frequency of darker pixels?
...
values only for those images that are not classified as "foggy"(0.4 or less haze).  
