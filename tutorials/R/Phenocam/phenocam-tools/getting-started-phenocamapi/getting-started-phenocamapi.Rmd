...
head(phenocam$site) #preview first six rows of the table. These are the first six phenocam sites in the Phenology Network

colnames(phenocam)  #view all column names. 
