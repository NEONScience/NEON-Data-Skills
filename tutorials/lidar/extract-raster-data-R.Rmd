...
```{r challenge-code-loops, eval=FALSE, comment=NA, echo=FALSE}
...
```{r challenge-code-square-shape, include=TRUE, results="hide", echo=FALSE, eval=FALSE, comment=NA}
# load shapefile data
...
```{r challenge-code-plot-95, include=TRUE, results="hide", echo=FALSE, eval=FALSE, comment=NA}
