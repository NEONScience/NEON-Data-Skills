...
<a href="/science-design/collection-methods/flux-tower-measurements" target="_blank"> temperature data collected using sensors on a flux tower</a> 
by 
...
Observatory Network (NEON) flux tower at the <a href="/field-sites/field-sites-map/OSBS" target="_blank">NEON field site - Ordway Swisher Biological Station (OSBS)</a>. 
Learn more about 
