...
```{r create-hdf5, eval=FALSE, comment=NA}
setwd(wd)
# create hdf5 file
...
```{r ref-attributes, eval=FALSE, comment=NA}
...
```{r populate-group-attributes, eval=FALSE, comment=NA}
...
```{r view-product}
View(h5ls(paste0(wd,"NEON_hyperspectral_tutorial_example_subset.h5", all=T)))
```