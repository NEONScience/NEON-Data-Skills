...
If you have already downloaded the data set for the Data Institute, you have the data for this tutorial within the SJER directory. If you would like to just download the data for this tutorial, use the following links. Once downloaded, save both of these files to your working directory. 
