...
-   <a href="https://github.com/NEONScience/NEON-utilities/blob/main/cheat-sheet-neonUtilities.pdf" target="_blank">neonUtilities cheat sheet</a>: R neonUtilities reference guide
...
byTileAOP(dpID="DP3.30018.002", # download the Canopy Nitrogen Product
          ...
          token=token) # make sure your API token is set!
```
