...
# resolution <- reflInfo$Spatial_Resolution_X_Y[1]
...
image(rgbStack$Band_14, main="Band 58", col=myCol)

#adjust the zlims or the stretch of the image
myCol=terrain.colors(25)
image(rgbStack$Band_14, main="Band 58", col=myCol, zlim = c(0,.5))
...
writeRaster(rgbStack, file=paste0(wd,"rgbImage.tif"), format="GTiff", overwrite=TRUE)
