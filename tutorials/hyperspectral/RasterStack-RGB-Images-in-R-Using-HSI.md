...
* Extract a "slice" of data from a hyperspectral data cube. </li>
* Create a rasterstack in R which can then be used to create RGB images from bands in a hyperspectral data cube.</li>
...
wavelength value for each band. 
</div>
