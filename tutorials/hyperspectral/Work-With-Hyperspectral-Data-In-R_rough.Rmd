...
f <- paste0(wd,"NEON_hyperspectral_tutorial_example_subset.h5") ## testing compatability with data downloaded from portal
...
b34<- h5read(f,"/SJER/Reflectance/Reflectance_Data",index=list(9,1:nCols,1:nRows)) 
