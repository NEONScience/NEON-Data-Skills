...
In this tutorial, we will work with NEON L3 LiDAR ecoysystem structure (Canopy Height Model) data product, but more generally will learn to read in a geotif raster data set. Refer to the links below for more information about the AOP data products:
