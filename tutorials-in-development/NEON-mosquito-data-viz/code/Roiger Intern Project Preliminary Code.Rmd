...
trap = read_csv('N:/Science/FSU/Intern Projects/2017_CharlotteRoiger/mos_trapping_in.csv', na = 'NA')
sort = read_csv('N:/Science/FSU/Intern Projects/2017_CharlotteRoiger/mos_sorting_in.csv', na = "NA")
id = read_csv('N:/Science/FSU/Intern Projects/2017_CharlotteRoiger/mos_identification_in.csv', na = "NA")
pathogen = read_csv('N:/Science/FSU/Intern Projects/2017_CharlotteRoiger/mos_pathogenresults_in.csv', na = "NA")
...
#source('~/mosquito-intern/code/mapping_viz.R')
...
#Using lapply and the get_NEON_location function to get a list of location information
...
trap <- merge(x = latlon.df, y = trap, by.x = "plotID", by.y = "plotID") #merge example
...
id$identifiedDate<- as.character(id$identifiedDate)
...
id$siteID<-substr(id$subsampleID, 1,4)
