...
description: "This is part three of a series of tutorials that show users how to clean and perform an initial analysis of NEON mosquito data."
tags: [R]
image: #update later
...
tars<- idsmall[grepl("Culex tarsalis", id$scientificName),]
