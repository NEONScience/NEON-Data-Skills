...
To start off this tutorial we will be pulling NEON mosquito data from the NEON
data portal. To accomplish this we must first set our working directory and then
use the `get_data_product` function to obtain mosquito data. Please fill in 
the example code below with your working directory to obtain NEON data.

```{r authors-wd-dataportal, echo=FALSE}
...
downloading 3 files (trapping, sorting, and identification data) and 
