...
```{shell launch-shell, echo=TRUE, eval=FALSE}
...
BIJAN: can we end the instance with a command? The only option I've found that 
works is the "Stop" button in RStudio but not everyone uses RStudio. 

```{r end-xROI, echo=TRUE, eval=FALSE}
# end shiny (xROI) app
...
BIJAN - I'm not able to get this to work.  I'm getting xROI to launch but can't 
bring in the images. Perhaps we could Skype to figure out what I'm doing wrong & 
how to improve the directions. 
