...
NEON tutorials, we don't explain every line of code, but your code chunks should 
be short enough that the text can explain what's happening in each one in a 
sentence or two.
* If you need to break the above rule, say so. For example, if your tutorial 
includes writing a function, but you're not concerned about users understanding 
the function in detail, say in the text that they can copy it and not worry 
about it too much. But you should generally avoid doing this - do it no more 
than once in one tutorial.
