...
Requirements
---
- Complete the introductory tutorials [AOP Data in Google Earth Engine (GEE) 101](https://github.com/NEONScience/NEON-Data-Skills/blob/bhass/tutorials-in-development/GEE/01_Intro_AOP_GEE/1a_GEE_AOP_101.md)
