...
library(reticulate)
use_python("C:/Users/nickerson/AppData/Local/Programs/Python/Python312/python.exe", required = TRUE)
...
```{python p-download-hidden, include=FALSE}
...
```{python p-download, eval=FALSE, results="hide", message=FALSE, warning=FALSE}
# Download continuous discharge data across the lifetime of a site
