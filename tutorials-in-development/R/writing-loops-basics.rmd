...
After having solved the issue with temperature, we realize that all the surveying measurements were done in feet and not meters! Given this random data set of X and Y coordinates, convert the set from feet to meters!
...
Start by creating our data set of apples. Some are good, some are rotten, and some are wormy.
