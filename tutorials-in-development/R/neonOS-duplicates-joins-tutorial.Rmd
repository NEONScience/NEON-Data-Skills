...
problem. There were consistent multiple matches between the two 
...
the values originating from each table are matched up before proceeding 
with your analysis.

SHOULD I WRITE A WHOLE SEPARATE TABLE JOIN TUTORIAL? CAN'T FIND WHAT I'M LOOKING FOR ELSEWHERE
