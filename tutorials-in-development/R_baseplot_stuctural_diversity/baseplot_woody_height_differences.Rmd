---
title: "Woody Vegetation Height Differences Tutorial"
code1: null
contributors: null
...
estimatedTime: null
languagesTool: R
packagesLibraries: sp, raster, neonUtilities, geoNeon
syncID: null
authors: Maxwell J. Burner
topics: NEON study plots, API calls, plant diversity, liDAR
tutorialSeries: 
urlTitle: baseplot-woody-height-differences
---


This tutorial will show you how draw on data NEON Woody Plant Vegetation Structure data to to assess how measured heights of trees in NEON baseplots differs between AOP measurements and TOS measurements.
...
* **geoNeon:** `install.packages("geoNeon")`
...
In this tutorial we will continue to use woody plant vegetation structure data (DP1.10098.001) to expand our dataframe for comparing vegetation structure between NEON baseplots. Our dataframe at this point has both Terrestrial Observation Sampling data (TOS) and Airborne Observational Photography data (AOP). Both of the particualr data products being used include measurements of tree height. 
