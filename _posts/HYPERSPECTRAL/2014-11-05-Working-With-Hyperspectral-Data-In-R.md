...
##About This Activity
In this activity we will explore reading spatial raster data stored within a HDF5 into `R`. Please be sure that you have *atleast* version 2.10 of `rhdf5` installed. Use: `packageVersion("rhdf5")` to check the package version. If you need to update `rhdf5`, use the following code:
