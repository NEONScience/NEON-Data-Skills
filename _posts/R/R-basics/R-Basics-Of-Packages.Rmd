...
authors: Leah A. Wasser - Activity Modified From Data Carpentry and Software Carpentry 
contributors: [ ]
...
* Load (use) an installed R package
* Update a package in R
* View thepackages are installed on your computer 
