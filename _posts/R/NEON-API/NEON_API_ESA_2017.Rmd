...
This product, camera imagery, is stored in TIFF files, and the file 
names are in the format BLAH. For a full list of AOP data products, 
their naming conventions, and their file formats, see BLAH.
...
# WHAT HAPPENS WHEN YOU KNIT THIS?
