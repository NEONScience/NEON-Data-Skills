...
<a class="btn btn-info" href="{{ site.baseurl }}/tutorial-series/capstone">
...
file with the naming convention:
 ...
 Save the file to the **participants/pre-institute2-git** directory in your
 local DI16-NEON-participants repo (the copy on your computer).
