...
description: "This tutorial covers how to set up a repository to update your local
repo with any any changes from the central repo."
date: 2016-05-13
...
<figure class="half">
	...
	<figcaption>LEFT: You will fork and clone a repo only <strong> ONCE </strong>. RIGHT: After you have forked
	and cloned a repo, you will update your fork from the central repository setting
