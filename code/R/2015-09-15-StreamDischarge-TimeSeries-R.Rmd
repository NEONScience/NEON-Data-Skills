...
<a href="http://www.neoninc.org/science-design/field-sites/posey-creek" target="_blank"> 
Posey Creek field site located in Virginia (NEON Domain 02)</a> and processed at NEON headquarters. The 
entire dataset and data for other field sites can be accessed from the <a href="http://neoninc.orgdata.neoninc.org" target="_blank">NEON data portal.</a>
</p>  
...
#remove the z
disArik$collectDate <- gsub("Z", " ",  a)

#set the field to be a date field
disArik$collectDate <- as.POSIXct(b,format = "%Y-%m-%d %H:%M:%S", 
                        tz = "GMT")
