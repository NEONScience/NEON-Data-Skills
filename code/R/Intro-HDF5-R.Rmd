...
1. Understand how HDF5 files can be created and structured in R using the rhfd5 libraries.
...
###Next let's add some Metadata (attributes) to our data
...
###Challenge -- 
 1. Open up the D17_2013_vegStr.csv in R. 
 2. Create a new H5 file called vegStructure.
 3. Add a group in your h5 file called SJER. Add the veg structure data to that folder!
 4. Add some attributes the data. Do the same with the SOAP csv.
